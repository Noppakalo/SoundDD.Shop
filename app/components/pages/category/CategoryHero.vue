<template>
        ...
        />
        <div
            class="relative flex min-h-[11.25rem] flex-col justify-center gap-2 overflow-hidden rounded-lg bg-gray-900 p-6 text-white shadow-lg"
        >
            <NuxtImg
            ...
            <div class="relative z-20 text-white">
                ...
                <p v-if="category?.description" class="max-w-2xl opacity-90">
